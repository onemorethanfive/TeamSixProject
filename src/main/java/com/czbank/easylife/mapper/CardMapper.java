...
public interface CardMapper {
    ...
    @Select("SELECT SUM(CAST(a.card_money AS  DECIMAL(18,2))) FROM card a,card_user_map b WHERE a.card_id = b.card_id AND b.user_id =#{userId};")
    public String getMoneyByUser(@Param("userId") String userId);
